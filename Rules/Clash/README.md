...
| [Apple.list](https://github.com/Amnesiash/ladder_rules_script/raw/main/Rules/Clash/Apple.list) | 苹果服务 | 直连 | 苹果公司的所有域名 | 
| [StreamingCN.list](https://github.com/Amnesiash/ladder_rules_script/raw/main/Rules/Clash/StreamingCN.list) | 港台番剧 | 直连 | 国内包含海外渠道的流媒体。BiliBili、爱奇艺等 |
...
| [Proxy.list](https://github.com/Amnesiash/ladder_rules_script/raw/main/Rules/Clash/Proxy.list) | 代理列表 | 代理 | GFW全量列表 |
| [LAN.list](https://github.com/Amnesiash/ladder_rules_script/raw/main/Rules/Clash/LAN.list) | 局域网 | 直连 | 本地地址和路由器直连域名啥的 |
